...
export const JiraPlugin = {
  install: function(Vue) {
    ...
    // 添加实例方法
    Vue.prototype.$initJira = function(protocol, host, username, password) {
      Vue.Jira = Vue.prototype.$jira = new JiraApi({ protocol, host, username, password, apiVersion: '2', strictSSL: true })
    }
  }
}
...
export default class JiraApi {
   ...
   * @param {string} [fields] - The list of fields to return for each issue.
   */
  getBoardIssuesForSprint(boardId, sprintId, startAt = 0, maxResults = 50, jql, validateQuery = true, fields) {
    return this.doRequest(
      this.makeRequestHeader(
        this.makeAgileUri({
